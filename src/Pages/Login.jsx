...
const LoginClient = () => {
    ...
    const authentificationclient= async(e)=>{
        e.preventDefault()
        try {

          const res = await axios.post('http://localhost:4000/Clients/loginclient',{
  ...
  return (
    <div className=' flex justify-center items-center w-full p-8 '>
        <div className=' shadow-2xl rounded-3xl p-6 mt-16'>
            ...
            <h2 className='text-blue-900 text-3xl font-extrabold px-24' > Pour client  </h2>
            </div>
            ...
            <button className=' bg-blue-800 text-white text-xl font-bold  p-5 rounded-3xl hover:bg-purple-950 hover:shadow-2xl ' onClick={authentificationclient}> Se Connecter </button>
